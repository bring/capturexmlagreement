...
public class ReadPercentageBasedFile {

    public List<Percentagebaseddump> readFileData(String fileLocation, String filecountry){
        List<Percentagebaseddump> contractdumps = new ArrayList<Percentagebaseddump>();
        try {
...
//                        currentRow = rows.next();
                    ...
                    Percentagebaseddump model = new Percentagebaseddump();
