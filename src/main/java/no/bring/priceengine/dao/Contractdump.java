...
@Entity
@Table(name = "contractdump",schema="core")
public class Contractdump implements Serializable , Comparable<Contractdump>{

    @Id
    @SequenceGenerator(sequenceName = "core.contractdump_serialid", name = "serialidSeq")
...
//    }
    ...
    @Override
    public int compareTo(Contractdump contractdump) {
